...
you should place your code here."
  ...
  (defun setup-iosevka-ligatures ()
    (load "~/config-files/ligatures.el")
    (setq prettify-symbols-alist
          (append prettify-symbols-alist haskell-ligatures)))
